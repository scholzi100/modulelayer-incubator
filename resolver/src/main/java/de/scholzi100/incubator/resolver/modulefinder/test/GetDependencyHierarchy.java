...
import de.scholzi100.incubator.resolver.modulefinder.test.util.ConsoleDependencyGraphDumper;
...
//        session.setConfigProperty( DependencyManagerUtils.CONFIG_PROP_VERBOSE, true );
        ...
        descriptorRequest.setRepositories( RepoResolverOverlay.newRepositories( system, session ) );
